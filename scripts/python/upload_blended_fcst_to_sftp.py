...
def main():
    ...
    logg_base = "%s/upload_blended_fcst_to_sftp" % (sys_path.Log_dir)
    ...
    blended_fcst_dir = os.path.join(sys_path.Data_base_dir, "nwp_statcast_blend")
    ...
    for dt in date_list:
        ...
        input_file = os.path.join(blended_fcst_dir, dt.strftime("%Y%m%d"), "NWP_statcast_blend.%s.nc" % dt.strftime("%Y%m%d.%H%M"))
