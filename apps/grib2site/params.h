 ...
 */
/* "$Id: params.h,v 1.13 2017/06/22 20:00:02 dicast Exp $" */
...
#define PARM_MAX_GUST	180	/* Max Wind gust in m/s */
...
#define PARM_RDRIP      188     /* rate of water dropping from canopy to ground */
...
#define PARM_PREIX	218	/* precip.index(0.0-1.00)(see note), fraction (percent?) */

//#define PARM_TSD1D	219	/* Std. dev. of IR T over 1x1 deg area, K */
#define PARM_CLOUD_HGT	219	/* Cloud height, m */  //NBM
...
#define PARM_SCLLWC      290    /* specific cloud liquid water content */
#define PARM_SCILWC      291    /* specific cloud ice water content */

// Added this for Composite Reflectivity (to get from NCEP HRRR and other models)
//
#define PARM_REFC        292    /* Composite reflectivity [dB]:entire atmosphere */

// Added this for Precip-Type (to get ptype from ECMWF) 
#define PARM_PTYPE       293    /* Precipitation Type at the surface */

#define PARM_GUST        294     /* Instantaneous Wind gust in m/s */

#define PARM_CBH         295    /* Cloud-base-heigt (meters: m) */

#define PARM_LAST_ENTRY  296	/* Keep this current if table is expanded.
...
extern "C" int param_code_e ( int grib_edition, int grib_table_version, int param );
...
extern "C" int param_g21(char *header, GRIB2::g2int g2pdtnum, GRIB2::g2int g2mdis,
			 GRIB2::g2int g2pcat,
...
extern int param_code_e ( int grib_edition, int grib_table_version, int param );
...
extern int param_g21(char *header, GRIB2::g2int g2pdtnum, GRIB2::g2int g2mdis,
		     GRIB2::g2int g2pcat,
		     GRIB2::g2int g2pnum, int *g1pver, int *g1pnum);
#else
extern char* grib_pname (/* int param_code */);
