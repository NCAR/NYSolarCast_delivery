 ...
 */
void cll2xy(const maparam * stcprm,double lat,double longit,
				  double * x,double *y ) ;
void cxy2ll(const maparam * stcprm,double x,double y,
...
vector_3d xy_map(const maparam * stcprm, double x, double y) ;     /*xymap*/
void map_xe(const maparam * stcprm, vector_3d map,x_y xieta[],int mode);   /*map_xe*/
void map_xy(const maparam * stcprm,vector_3d map,double * x,double * y) ;
																				 /*map_xy*/
void xe_xy(const maparam * stcprm, double xi, double eta,
			double * x,double * y) ;                            /*xe_xy*/
void xy_xe(const maparam * stcprm, double x, double y,
 ...
 * negative x- side
 */
vector_3d basegtom(const maparam * stcprm,vector_3d xin) ;         /*basg2m*/
vector_3d basemtog(const maparam * stcprm,vector_3d xin) ;         /*basm2g*/
